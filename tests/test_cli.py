...
"""
    ...
    def test_install_script_bootstraps_local_prefix_contract(self) -> None:
        ...
        self.assertIn('SPARK_CLI_RELEASE_NAME="${SPARK_CLI_RELEASE_NAME:-spark-cli-launch-2026-05-02-2}"', script)
        self.assertIn('SPARK_DEFAULT_CLI_REF="0db74200fc9e1ce9c73d9a65d68c85fd165ccc8f"', script)
    ...
    def test_windows_install_script_bootstraps_local_prefix_contract(self) -> None:
        ...
        self.assertIn('[string]$Ref = "0db74200fc9e1ce9c73d9a65d68c85fd165ccc8f"', script)
        self.assertIn('$SparkCliReleaseName = "spark-cli-launch-2026-05-02-2"', script)
